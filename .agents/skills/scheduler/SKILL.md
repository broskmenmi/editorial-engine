...
2. The playlist directory must contain `automation.md`, `constitution.md`, `feedback-protocol.md`, `ledger.md`, `under-review.md`, `journey-annotations.json`, `spotify.json`, and `spotify-status.json`.
...
20. Never surface unrelated Spotify playlists or broad fallback results.
