...
6. Allow pre-audit to return `NO GENUINE SCOUTING TARGET`; in that case skip Scout through Sequencer, create no candidate snapshot, audit the stop, and report no ledger change.
7. Treat GitHub as the persistent source of truth.
