...
|---:|---|---|---|---|---|
| 1 | Rene Wise | Deep Under | ADD | Opening immersion layer | 2026-07-15 |
| 2 | Maeksll | Two Glasses of Whisky | ADD | Deep-entry continuation | Initial ledger |
...
1. **Immersion** — enter patiently; no announcement or spectacle.
2. **Deep groove** — establish sustained movement.
