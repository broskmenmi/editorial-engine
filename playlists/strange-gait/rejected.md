...
Durable rejections are scoped to STRANGE GAIT and their documented current journey/function unless the evidence clearly establishes global identity failure.

A track rejected from GROOVE OVER NOISE is not automatically rejected here, and a STRANGE GAIT rejection does not alter Volume I.
...
| Mitra | Hush | Rejected for the Track 2 bootstrap role/current journey. Exact 137 BPM and a viable 136→137 handoff were verified, but available source evidence foregrounds bass-heavy bubbly texture and warm propulsion more clearly than a distinct STRANGE GAIT gait deformation. No global sonic-incompatibility claim. | 2026-09-05 |
